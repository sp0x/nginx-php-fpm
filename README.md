...
This is a fork of https://github.com/ngineered/nginx-php-fpm
...
The following flags are a list of all the currently supported options that can be changed by passing in the variables to docker with the -e flag.
 ...
 - **WEBROOT** : Change the default webroot directory from `/var/www` to your own setting
...
```
### WebRoot
You can set your webroot in the container to anything you want using the ```WEBROOT``` variable e.g -e "WEBROOT=/var/www/public". By default code is checked out into /var/www/ so if your git repository does not have code in the root you'll need to use this variable.
